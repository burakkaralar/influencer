...
<div class="card card-flush h-md-100">
	...
	<div class="card-header pt-7">
		<div style="display:flex;  align-items:center; margin-bottom:30px;">
			<input type="text" placeholder="Arama" class="form-control form-control-sm form-control-solid" style="width:100%; display:block;" id="saglayici_search">
		</div>
	...
	<div class="card-body pt-6">
		...
		<div class="table-responsive">
			<!--begin::Table-->
			<table class="table table-row-dashed align-middle gs-0 gy-3 my-0" id="saglayici_table">
				<!--begin::Table head-->
				<thead>
					<tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
						<th class="">SAĞLAYICI TİPİ</th>
						<th class="">AD SOYAD / AJANS ADI</th>
						<th class="">YETKİLİ</th>
						<th class="">EMAİL</th>
						<th class="">TELEFON</th>
						<th class="">OLUŞTURULMA TARİHİ</th>
						<th class="">GÜNCELLENME TARİHİ</th>
						<th class="">İŞLEM</th>
					</tr>
				</thead>
				<!--end::Table head-->
