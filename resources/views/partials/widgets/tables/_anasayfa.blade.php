...
<div class="card card-flush h-md-100">
	...
	<div class="card-header pt-7">
		<div style="display:flex;  align-items:center; margin-bottom:30px;">
			<a href="javascript:void(0)" class="btn btn-sm btn-primary" style="margin-right:20px;" id="excel_filtre_btn" action="">Excel</a>
			...
			<table class="table table-row-dashed align-middle gs-0 gy-3 my-0" id="influencer_hesap">
				...
				<thead>
					<tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
						...
						<th class="">Dil</th>
						<th class="">Doğrulanmış Hesap</th>
						<th class="">Sağlayıcı</th>
						<th class="">Etiketler</th>
						<th class="">Oluşturulma Tarihi</th>
						<th class="">Güncellenme Tarihi</th>
					</tr>
				</thead>
				<!--end::Table head-->
				<!--begin::Table body-->
