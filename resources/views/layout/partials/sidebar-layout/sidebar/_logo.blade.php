...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	...
	<a href="/">
		...
		@if ($bodyAttribute === 'dark-sidebar')
			<img alt="Logo" src="{{ image('logos/logo-white.png') }}" class="h-50px app-sidebar-logo-default" />
		...
		<img alt="Logo" src="{{ image('logos/social-media.png') }}" class="h-35px app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
